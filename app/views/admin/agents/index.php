<button class="btn btn-primary create-btn">ایجاد نماینده جدید</button>
        ...
        <?php foreach ($agents as $agent) : ?>
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-danger delete-btn" data-id="<?php echo $agent['id']; ?>">حذف</button>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
...
<nav>
    <ul class="pagination">
        <?php for ($i = 1; $i <= ceil($totalAgents / $limit); $i++) : ?>
        ...
        <div class="modal-content">
            <form id="createForm">
                <div class="modal-header">
                    <h5 class="modal-title" id="createModalLabel">ایجاد نماینده جدید</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="editForm">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">ویرایش نماینده</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="بستن"></button>
                </div>
                <div class="modal-body">
